...
namespace MetodosComunsApi
{
    public static class MetodosExtensaoComuns
    {
        ...
        public static string FormatCNPJ(this string CNPJ)   => MetodosComunsApi.MetodosComuns.FormatCNPJ(CNPJ);
        ...
        public static string FormatCPF(this string CPF) => MetodosComunsApi.MetodosComuns.FormatCPF(CPF);
